...
const primaryStyle: GlobalStyle = {
    ...
    boxShadow5: 'inset 0px 0px 0px #161617, inset 0px 0px 0px #262627, -1px 1px 3px var(--background-secondary1), 1px -1px 2px #272729;',
...
const secondaryStyle: GlobalStyle = {
    ...
    boxShadow5: 'inset 0px 0px 0px #161617, inset 0px 0px 0px #262627, -1px 1px 3px var(--background-secondary1), 1px -1px 2px #fffffe;',
