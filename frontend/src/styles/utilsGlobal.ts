...
const primaryStyle: GlobalStyle = {
    ...
    boxShadowInset1: 'inset -3px 3px 10px #161617, inset 3px -3px 10px #262627, 0px 0px 0px #272729, 0px 0px 0px #272729;',
...
const secondaryStyle: GlobalStyle = {
    ...
    boxShadow1: 'inset 0px 0px 0px #d2d1ce, inset 0px 0px 0px #ffffff, -5px 5px 8px #ebeae6, 5px -5px 8px #fffffe;',
    ...
    boxShadowInset1: 'inset -3px 3px 7px #d2d1ce, inset 3px -3px 7px #ffffff, 0px 0px 0px #ebeae6, 0px 0px 0px #fffffe;',
