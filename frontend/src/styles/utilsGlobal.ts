...
const primaryStyle: GlobalStyle = {
    ...
    // success1: 'rgb(70, 209, 96);',
    success1: '#009670;',
    success2: '#00bc8c;',
    // success2: '#1FB874;',
    // success2: 'rgb(70, 209, 96);',
    warning1: '#ca6702;',
    warning2: '#ee9b00;',
    danger1: '#D22730;',
    ...
    boxShadow3: 'inset 0px 0px 0px #161617, inset 0px 0px 0px #262627, -27px 27px 54px #151515, 1px -1px 2px #272729;',
    boxShadow4: 'inset 0px 0px 0px #161617, inset 0px 0px 0px #262627, -41px 41px 82px #151515, 1px -1px 2px #272729;',
    boxShadow5: 'inset 0px 0px 0px #161617, inset 0px 0px 0px #262627, -1px 1px 3px var(--background-blur1), 1px -1px 2px #272729;',
    ...
    boxShadowClay1: 'inset 0.3em -0.3em 0.6em #151515, inset -0.2em 0.3em 0.8em hsl(240, 2%, 22%), -0.2em 0.2em 0.3em #151515;',
    boxShadowClay2: 'inset 0.3em -0.3em 0.6em #151515, inset -0.1em 0.2em 0.6em hsl(240, 2%, 22%), -0.9em 0.9em 0.4em #151515;',
    boxShadowClay3: 'inset 0.15em -0.15em 0.3em #151515, inset -0.05em 0.08em 0.3em hsl(240, 2%, 22%), -0.051em 0.051em 0.2em #151515;',
    boxShadowClay4: 'inset 0.25em -0.45em 1.9em #151515, inset 0.475em 0.475em 0.45em hsl(240, 2%, 22%), -0.43em 0.43em 4.95em #151515;',
...
const secondaryStyle: GlobalStyle = {
    ...
    // boxShadowClay2: 'inset 0.1em -0.1em 0.4em #a8a7a5, inset 0.3em 0.3em 0.6em hsl(228, 34%, 93%), -0.09em 0.09em 0.2em #8d8c8a;',
    boxShadowClay1: 'inset 0.06em -0.06em 0.25em #a8a7a5, inset 0.2em 0.2em 0.4em hsl(228, 34%, 93%), -0.08em 0.08em 0.15em #8d8c8a;',
    boxShadowClay2: 'inset 0.05em -0.05em 0.2em #a8a7a5, inset 0.15em 0.15em 0.3em hsl(228, 34%, 93%), -0.06em 0.06em 0.1em #8d8c8a;',
    boxShadowClay3: 'inset 0.025em -0.05em 0.1em #a8a7a5, inset 0.075em 0.075em 0.15em hsl(228, 34%, 93%), -0.03em 0.03em 0.05em #8d8c8a;',
    boxShadowClay4: 'inset 0.425em -0.45em 0.9em #a8a7a5, inset 0.475em 0.475em 0.45em hsl(228, 34%, 93%), -3.43em 3.43em 3.45em #8d8c8a;',

    // boxShadowClay2: 'inset 0.3em -0.3em 0.7em #a8a7a5, inset 0.4em 0.4em 0.9em hsl(228, 34%, 93%), -0.15em 0.15em 0.5em #8d8c8a;',
