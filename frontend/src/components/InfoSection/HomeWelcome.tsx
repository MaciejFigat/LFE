            ...
            <InfoColumn>
              <TextWrapper>
                ...
                <Subtitle variant={variant}>
                  ...
                  Natomiast każde wyszukiwanie jest w pewien sposób uogólniane,
                  by w przypadku słabych wyników na słowach kluczowych pokazać
                  te, które są jak najbardziej zbliżone do rządanej frazy. W
                  obecnej chwili wyszukiwarka daje dostęp do 100
                  najtrafniejszych odpowiedzi.
                </Subtitle>
                <Subtitle variant={variant}>
                ...
                <Subtitle variant={variant}>
                  Nasz system jest eksperymentalny i będący w fazie rozwoju. Dla
                  każdego wyniku prezentowana jest istota interpretacji i
                  maksymalnie 4 fragmenty tekstu, które najbardziej odpowiadają
                  na szukaną frazę. W najbliższym czasie planujemy też dodanie
                  do bazy danych archiwalnych interepretacji podatkowych.
                </Subtitle>
              </TextWrapper>
            </InfoColumn>
          </InfoRow>
